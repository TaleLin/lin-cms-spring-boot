...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 如果模板引擎是 freemarker
        String templatePath = "/mpg/templates/mapper.xml.ftl";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/resources/mapper/" + tableInfo.getEntityName().replace("DO", "") + "Mapper" + StringPool.DOT_XML;
            }
        });
        /*
